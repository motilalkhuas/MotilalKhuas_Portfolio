...
const Home = () => {
  return (
        <>
            <div className="grid lg:grid-cols-12 lg:pt-5 md:px-28 sm:px-20 px-12 lg:px-0">
                <div className="grid grid-cols-1 lg:col-start-2 lg:col-span-5 lg:mr-10">
                    <div className=" sm:h-0 lg:h-20 h-20 px-10 pt-2">
                        <img
                            src={triangle}
                            alt="triangle"
                    ...
                    <div>
                        <div className="lg:text-6xl text-5xl font-roboto font-bold">
                            I'm Motilal.
                        </div>
                        <div className="text-[rgb(47,46,65)] text-[18px] md:text-lg font-poppins h-auto pt-4 pb-5">
